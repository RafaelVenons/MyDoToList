  ...
  let mockMetas = [
    {
      ...
      feito: [true, true, false, false, false, false, true],
      id: "4-Meta",
      nome: "Quarta Meta",
    },
    {
      desc: "Descricao doida",
      dias: [false, true, true, true, true, true, false],
      feito: [true, true, true, true, false, false, false],
      id: "3-Meta",
      nome: "Terceira Meta",
    },
    {
      desc: "Descricao doida",
      dias: [false, true, true, true, true, true, false],
      feito: [true, true, true, true, false, false, true],
      id: "2-Meta",
      nome: "Segunda Meta",
    },
    {
      desc: "",
      dias: [false, true, true, true, true, true, false],
      feito: [true, true, true, true, true, true, false],
      id: "1-Meta",
      nome: "Primeira Meta",
    },
  ];
